...
var mongooseSessionImport = require('mongoose');
var SessionSchema = mongooseSessionImport.Schema; // function to create a schema
// We can use it to make a schema to enforce like so.
var sessionSchema = new SessionSchema({
    _id: {
