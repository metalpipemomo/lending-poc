      ...
      <div id="dashboard-container" className="flex flex-col justify-center items-center">
        <div id="dashboard-header" className="flex justify-between w-full h-fit p-1.5 pl-3 text-slate-700 bg-white">
          ...
          <div className="flex justify-between gap-1.5">
            <Link href="/dashboard/matches" id="dashboard-link-view-matches" className="w-fit px-3 py-2 text-sm font-semibold rounded-full shadow-sm  bg-black text-white hover:bg-gray-300 hover:text-gray-800 hover:border-gray-800 focus:outline-none focus:ring-2"><h2 className="">View Matches</h2></Link>
